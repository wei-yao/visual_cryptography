...
public class VisualCryptography extends JFrame implements ActionListener {
    ...
    private JButton btnGenerateKeyAndEncrypt = new JButton(
            "<html><center>Generate Key & Encrypt Image at the same time</center></html>");
    ...
    public VisualCryptography() {
        ...
        btnGenerateKey.setMaximumSize(new Dimension(Integer.MAX_VALUE, btnGenerateKey
                .getMaximumSize().height));
        btnEncrypt.setMaximumSize(new Dimension(Integer.MAX_VALUE,
                btnEncrypt.getMaximumSize().height));
        btnGenerateKeyAndEncrypt.setMaximumSize(new Dimension(Integer.MAX_VALUE,
                btnGenerateKeyAndEncrypt.getMaximumSize().height));
        btnDecrypt.setMaximumSize(new Dimension(Integer.MAX_VALUE,
                btnDecrypt.getMaximumSize().height));
